...
if __name__ == "__main__":
    ...
    parser.add_argument('-sampling',type =str,help='choose from: "random_uniform", "low_pass", "VDS", "GMS", "LOUPE", "DPS", "ADPS" ,"PGADPS"', default='DPS')
    ...
    parser.add_argument('-percentage_Ps',type =int,help='percentage of prior (deterministic) sampling',default=30)  
    parser.add_argument('-percentage_As',type =int,help='percentage of Blocks of Active sampling',default=30) 
    ...
    if args.sampling == 'PGADPS':
        args.save_name = args.sampling +"_"+str(args.no_lines)+"lines_"+str(args.percentage_Ps)+"Ps_"+str(args.percentage_As)+"As_"+str(args.seed)+"seed"
    else:
    ...
    if args.sampling == "PGADPS":
        Network = myModel.PGADPSMask(args)
