...
class PGADPSMask(nn.Module):
       def __init__(self,args):
           ...
           args.mux_in = self.width    
           self.mux_out_first = int(args.no_lines*args.percentage_Ps/100)
           self.mux_out = int(args.no_lines*args.percentage_As/100)
           left_pixels = args.no_lines-self.mux_out_first
...
class PGADPSMask_legacy(nn.Module):
       def __init__(self,args):
           super(PGADPSMask_legacy,self).__init__()
           self.device = args.device
           self.Pineda = args.Pineda
           self.batch_size = args.batch_size
