...
if __name__ == "__main__":
    ...
    if args.sampling == 'PGADPS':
        args.save_name = args.sampling +"_"+str(args.no_lines)+"lines_"+str(args.percentage_DPS)+"Ps_"+str(args.percentage_Block_ADPS)+"As_"+str(args.seed)+"seed"
    else:
    ...
    if args.sampling == "PGADPS" and args.Pineda == False:
        Network = myModel.PGADPSMask(args)
    if args.sampling == "PGADPS" and args.Pineda == True:
