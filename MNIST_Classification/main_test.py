...
if __name__ == "__main__":
    ...
    parser.add_argument('-sampling',type =str,help='choose from: "DPS" or "ADPS" or "PGADPS"',default='ADPS')
    parser.add_argument('-percentage',type =int,help='percentage of samples to use',default=1)
    parser.add_argument('-percentage_Ps',type =int,help='percentage of prior sampling',default=60)  
    ...
    if args.sampling == 'PGADPS':
        args.save_name = args.sampling +"_"+str(args.percentage)+"percent_"+str(args.percentage_Ps)+"Ps_"+str(args.percentage_As)+"As_"+str(args.seed)+"seed"
    else:
